...
std::string get_formatted_time(const std::string& date_time, const std::string& locale) {
  std::stringstream ss("");
  try {
...
//date_time is in the format of 2015-05-06T08:00
std::string get_formatted_date(const std::string& date_time, const std::string& locale) {
  std::stringstream ss("");
  try {
    if (date_time.find("T") == std::string::npos)
      return ss.str();
