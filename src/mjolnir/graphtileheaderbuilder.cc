...
void GraphTileHeaderBuilder::set_nodecount(unsigned int nodecount) {
  nodecount_ = nodecount;
}

// Sets the number of directed edges in this tile.
void GraphTileHeaderBuilder::set_directededgecount(
    unsigned int directededgecount) {
  directededgecount_ = directededgecount;
}

// Sets the offset to the edge info.
void GraphTileHeaderBuilder::set_edgeinfo_offset(unsigned int edgeinfo_offset) {
  edgeinfo_offset_ = edgeinfo_offset;
}

// Sets the offset to the name list.
void GraphTileHeaderBuilder::set_namelist_offset(unsigned int namelist_offset) {
