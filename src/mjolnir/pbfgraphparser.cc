...
struct graph_parser {
  graph_parser(const boost::property_tree::ptree& pt, OSMData& osmdata)
    ...
    tag_handlers_["vignette"] = [this]() {
      ...
      restriction.set_modes(kAutoAccess | kTruckAccess | kTaxiAccess | kBusAccess | kMotorcycleAccess);
    ...
    tag_handlers_["vignette"] = [this]() { way_.set_vignette(tag_.second == "true" ? true : false); };
