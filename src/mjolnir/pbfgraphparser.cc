...
public:
  ...
  graph_callback(const boost::property_tree::ptree& pt, OSMData& osmdata)
    ...
    c["auto_forward"] = [this]() { w.set_auto_forward(tag.second == "true" ? true : false); };
    c["truck_forward"] = [this]() { w.set_truck_forward(tag.second == "true" ? true : false); };
    c["bus_forward"] = [this]() { w.set_bus_forward(tag.second == "true" ? true : false); };
    c["bike_forward"] = [this]() { w.set_bike_forward(tag.second == "true" ? true : false); };
    c["emergency_forward"] = [this]() {
      w.set_emergency_forward(tag.second == "true" ? true : false);
    };
    c["hov_forward"] = [this]() { w.set_hov_forward(tag.second == "true" ? true : false); };
    c["taxi_forward"] = [this]() { w.set_taxi_forward(tag.second == "true" ? true : false); };
    c["moped_forward"] = [this]() { w.set_moped_forward(tag.second == "true" ? true : false); };
    c["motorcycle_forward"] = [this]() {
      w.set_motorcycle_forward(tag.second == "true" ? true : false);
    };
    c["auto_backward"] = [this]() { w.set_auto_backward(tag.second == "true" ? true : false); };
    c["truck_backward"] = [this]() { w.set_truck_backward(tag.second == "true" ? true : false); };
    c["bus_backward"] = [this]() { w.set_bus_backward(tag.second == "true" ? true : false); };
    c["bike_backward"] = [this]() { w.set_bike_backward(tag.second == "true" ? true : false); };
    c["emergency_backward"] = [this]() {
      w.set_emergency_backward(tag.second == "true" ? true : false);
    };
    c["hov_backward"] = [this]() { w.set_hov_backward(tag.second == "true" ? true : false); };
    c["taxi_backward"] = [this]() { w.set_taxi_backward(tag.second == "true" ? true : false); };
    c["moped_backward"] = [this]() { w.set_moped_backward(tag.second == "true" ? true : false); };
    c["motorcycle_backward"] = [this]() {
      w.set_motorcycle_backward(tag.second == "true" ? true : false);
    };
    c["pedestrian"] = [this]() { w.set_pedestrian(tag.second == "true" ? true : false); };
    c["private"] = [this]() {
    ...
    c["no_thru_traffic"] = [this]() { w.set_no_thru_traffic(tag.second == "true" ? true : false); };
    c["oneway"] = [this]() { w.set_oneway(tag.second == "true" ? true : false); };
    c["oneway_reverse"] = [this]() { w.set_oneway_reverse(tag.second == "true" ? true : false); };
    c["roundabout"] = [this]() { w.set_roundabout(tag.second == "true" ? true : false); };
    c["link"] = [this]() { w.set_link(tag.second == "true" ? true : false); };
    c["ferry"] = [this]() { w.set_ferry(tag.second == "true" ? true : false); };
    c["rail"] = [this]() { w.set_rail(tag.second == "true" ? true : false); };
    c["duration"] = [this]() {
    ...
    c["truck_route"] = [this]() { w.set_truck_route(tag.second == "true" ? true : false); };
    c["hazmat"] = [this]() {
    ...
    c["direction"] = [this]() {
      if (!tag.second.empty() && use_direction_on_ways_)
        direction = tag.second;
    };
    c["int_direction"] = [this]() {
      if (!tag.second.empty() && use_direction_on_ways_)
    ...
    c["shoulder_right"] = [this]() { w.set_shoulder_right(tag.second == "true" ? true : false); };
    c["shoulder_left"] = [this]() { w.set_shoulder_left(tag.second == "true" ? true : false); };
    c["cycle_lane_right"] = [this]() {
    ...
    c["cycle_lane_right_opposite"] = [this]() {
      w.set_cyclelane_right_opposite(tag.second == "true" ? true : false);
    };
    c["cycle_lane_left_opposite"] = [this]() {
    ...
    c["forward_lanes"] = [this]() {
      w.set_forward_lanes(std::stoi(tag.second));
      w.set_forward_tagged_lanes(true);
    };
    c["backward_lanes"] = [this]() {
      w.set_backward_lanes(std::stoi(tag.second));
      w.set_backward_tagged_lanes(true);
    };
    c["tunnel"] = [this]() { w.set_tunnel(tag.second == "true" ? true : false); };
    c["toll"] = [this]() { w.set_toll(tag.second == "true" ? true : false); };
    c["bridge"] = [this]() { w.set_bridge(tag.second == "true" ? true : false); };
    c["seasonal"] = [this]() { w.set_seasonal(tag.second == "true" ? true : false); };
    c["bike_network_mask"] = [this]() { w.set_bike_network(std::stoi(tag.second)); };
    c["bike_national_ref"] = [this]() {
      if (!tag.second.empty())
        w.set_bike_national_ref_index(osmdata_.name_offset_map.index(tag.second));
    };
    c["bike_regional_ref"] = [this]() {
      if (!tag.second.empty())
        w.set_bike_regional_ref_index(osmdata_.name_offset_map.index(tag.second));
    };
    c["bike_local_ref"] = [this]() {
      if (!tag.second.empty())
  ...
  virtual void way_callback(const uint64_t osmid_,
    ...
    default_speed = 0.0f, max_speed = 0.0f;
    average_speed = 0.0f, advisory_speed = 0.0f;
    has_default_speed = false, has_max_speed = false;
    has_average_speed = false, has_advisory_speed = false;
    has_surface = true;
    name = {};
    ...
    for (const auto& kv : results) {
      tag = kv;
      const auto it = c.find(tag.first);
      if (it != c.end()) {
        it->second();
      }
