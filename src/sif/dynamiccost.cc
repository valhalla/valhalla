...
BaseCostingOptionsConfig::BaseCostingOptionsConfig()
    : dest_only_penalty_{0.f, kDefaultDestinationOnlyPenalty, kMaxPenalty},
      ...
      exclude_tunnels_(false), exclude_tolls_(false), exclude_vignettes_(false), exclude_highways_(false), 
...
void ParseBaseCostOptions(const rapidjson::Value& json,
  ...
  JSON_PBF_DEFAULT_V2(co, cfg.exclude_vignettes_, json, "/exclude_vignettes", exclude_vignettes);
