...
public:
   ...
   */
  virtual void AddToExcludeList(const boost::intrusive_ptr<const baldr::GraphTile>& tile) override;
...
void TransitCost::AddToExcludeList(const boost::intrusive_ptr<const baldr::GraphTile>& tile) {
...
bool TransitCost::IsExcluded(const boost::intrusive_ptr<const baldr::GraphTile>& tile,
