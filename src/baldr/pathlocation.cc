...
void PathLocation::toPBF(const PathLocation& pl, valhalla::Location* l, baldr::GraphReader& reader) {
  {
...
baldr::Location::StopType PathLocation::fromPBF(valhalla::Location::Type type) {
...
Location PathLocation::fromPBF(const valhalla::Location& loc) {
