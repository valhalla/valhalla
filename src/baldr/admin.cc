...
constexpr std::pair<std::string_view, std::string_view> iso2_to_iso3_data[] = {
    {"AD", "AND"}, {"AE", "ARE"}, {"AF", "AFG"}, {"AG", "ATG"}, {"AI", "AIA"}, {"AL", "ALB"},
    {"AM", "ARM"}, {"AO", "AGO"}, {"AN", "ANT"}, {"AQ", "ATA"}, {"AR", "ARG"}, {"AS", "ASM"},
    ...
    {"CN", "CHN"}, {"CO", "COL"}, {"CR", "CRI"}, {"CS", "SCG"}, {"CU", "CUB"}, {"CV", "CPV"},
    {"CW", "CUW"}, {"CX", "CXR"}, {"CY", "CYP"}, {"CZ", "CZE"}, {"DE", "DEU"}, {"DJ", "DJI"},
    {"DK", "DNK"}, {"DM", "DMA"}, {"DO", "DOM"}, {"DZ", "DZA"}, {"EC", "ECU"}, {"EE", "EST"},
    {"EG", "EGY"}, {"EH", "ESH"}, {"ER", "ERI"}, {"ES", "ESP"}, {"ET", "ETH"}, {"FI", "FIN"},
    {"FJ", "FJI"}, {"FK", "FLK"}, {"FM", "FSM"}, {"FO", "FRO"}, {"FR", "FRA"}, {"GA", "GAB"},
    ...
    {"XK", "XKX"}, {"YE", "YEM"}, {"YT", "MYT"}, {"ZA", "ZAF"}, {"ZM", "ZMB"}, {"ZW", "ZWE"},
};
constexpr auto iso2_to_iso3 = valhalla::midgard::ConstFlatMap(iso2_to_iso3_data);
...
std::string get_iso_3166_1_alpha3(const std::string& iso_3166_1_alpha2) {
  ...
  return iter == iso2_to_iso3.end() ? std::string() : std::string(iter->second);
}
