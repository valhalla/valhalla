...
public:
  ...
  vs::Cost EdgeCost(const vb::DirectedEdge* edge, const float speed) const;
...
vs::Cost DistanceOnlyCost::EdgeCost(const vb::DirectedEdge* edge, const float speed) const {
