...
namespace valhalla {
  ...
  worker_t::result_t thor_worker_t::trip_path(const std::string &costing, const std::string &request_str, const boost::optional<int> &date_time_type, http_request_t::info_t& request_info){
