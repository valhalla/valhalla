...
//
// This is a C++ wrapper with slight modification of a hungarian algorithm implementation by Markus
// Buehren. The original implementation is a few mex-functions for use in MATLAB, found here:
