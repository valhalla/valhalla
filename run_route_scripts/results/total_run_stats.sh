...
{
  read; # Read header
  while IFS=, read IN_ORIG_LAT IN_ORIG_LNG IN_DEST_LAT IN_DEST_LNG IN_RESULT IN_NUM_PASSES IN_RUN_TIME IN_TRIP_TIME IN_TRIP_LENGTH IN_ARC_DISTAANCE IN_NUM_MANEUVERS
  do
