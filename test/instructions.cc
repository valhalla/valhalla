...
void validate_ramp_instructions() {
  ...
  // Test take toward
  test_instructions({VALHALLA_SOURCE_DIR "test/pinpoints/instructions/ramp_take_toward.pbf"},
                    expected_routes_size, expected_legs_size, expected_maneuvers_size, maneuver_index,
...
void validate_exit_instructions() {
  ...
  // Test exit left
  test_instructions({VALHALLA_SOURCE_DIR "test/pinpoints/instructions/exit_left.pbf"},
                    expected_routes_size, expected_legs_size, expected_maneuvers_size, maneuver_index,
