...
[[maybe_unused]] OSMNode GetNode(uint64_t node_id, sequence<OSMWayNode>& way_nodes) {
  auto found = way_nodes.find({node_id, 0, 0}, node_predicate);
...
[[maybe_unused]] OSMWay GetWay(uint32_t way_id, sequence<OSMWay>& ways) {
