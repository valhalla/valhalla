...
constexpr float kDefaultPedestrian_WalkwayFactor = 0.85f;  // Slightly favorable value for walkways
constexpr float kDefaultPedestrian_SideWalkFactor = 0.85f; // Slightly favorable value for sidewalks
