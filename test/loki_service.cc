...
namespace {
  ...
  const std::vector<std::pair<uint16_t,std::string> > responses {
    ...
    {405, std::string("{\"error_code\":101,\"error\":\"Try a POST or GET request instead\",\"status_code\":405,\"status\":\"Method Not Allowed\"}")},
    {405, std::string("{\"error_code\":101,\"error\":\"Try a POST or GET request instead\",\"status_code\":405,\"status\":\"Method Not Allowed\"}")},
    {404, std::string("{\"error_code\":102,\"error\":\"Try any of:\'\\/locate\' \'\\/route\' \'\\/one_to_many\' \'\\/many_to_one\' \'\\/many_to_many\' \'\\/sources_to_targets\' \'\\/optimized_route\' \'\\/isochrone\' \",\"status_code\":404,\"status\":\"Not Found\"}")},
    {404, std::string("{\"error_code\":102,\"error\":\"Try any of:\'\\/locate\' \'\\/route\' \'\\/one_to_many\' \'\\/many_to_one\' \'\\/many_to_many\' \'\\/sources_to_targets\' \'\\/optimized_route\' \'\\/isochrone\' \",\"status_code\":404,\"status\":\"Not Found\"}")},
    ...
    {400, std::string("{\"error_code\":112,\"error\":\"Insufficiently specified required parameter \'locations\' or \'sources & targets\'\",\"status_code\":400,\"status\":\"Bad Request\"}")},
    {400, std::string("{\"error_code\":140,\"error\":\"Failed to parse location\",\"status_code\":400,\"status\":\"Bad Request\"}")},
    {400, std::string("{\"error_code\":140,\"error\":\"Failed to parse location\",\"status_code\":400,\"status\":\"Bad Request\"}")},
    {400, std::string("{\"error_code\":130,\"error\":\"Insufficient number of locations provided\",\"status_code\":400,\"status\":\"Bad Request\"}")},
    {400, std::string("{\"error_code\":130,\"error\":\"Insufficient number of locations provided\",\"status_code\":400,\"status\":\"Bad Request\"}")},
    ...
    {400, std::string("{\"error_code\":164,\"error\":\"Path distance exceeds the max distance limit\",\"status_code\":400,\"status\":\"Bad Request\"}")},
    {400, std::string("{\"error_code\":199,\"error\":\"Unknown:No costing method found for 'yak'\",\"status_code\":400,\"status\":\"Bad Request\"}")},
    {400, std::string("{\"error_code\":199,\"error\":\"Unknown:No costing method found for 'yak'\",\"status_code\":400,\"status\":\"Bad Request\"}")},
