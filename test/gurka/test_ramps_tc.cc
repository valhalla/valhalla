  ...
  static void SetUpTestSuite() {
    ...
    const gurka::ways ways =
          {{"AM",
           ...
           {"CP", {{"highway", "primary"}, {"oneway", "yes"},}},
           {"PD", {{"highway", "primary"}, {"oneway", "yes"},}},
           {"FG",
            {{"highway", "primary"},
             {"oneway", "yes"},
             {"internal_intersection", "true"},
           ...
           {"NJ", {{"highway", "primary"}, {"oneway", "yes"}, }},
           {"KO", {{"highway", "primary"}, {"oneway", "yes"}, }},
           {"OC", {{"highway", "primary"}, {"oneway", "yes"}, }},
           {"CF",
            {{"highway", "primary"},
             {"oneway", "yes"},
             {"internal_intersection", "true"},
             }},
           {"FR", {{"highway", "primary"}, {"oneway", "yes"}, }},
           {"RL", {{"highway", "primary"}, {"oneway", "yes"}, }}};
