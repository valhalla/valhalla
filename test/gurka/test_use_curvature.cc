...
// At use_curvature=0.75 (below the ~0.90 threshold) the curvature preference is not yet strong
...
// At use_curvature=1.0 (above the threshold) the curvature discount (factor ≈ 0.34 for c≈10)
// reduces the curvy road's effective cost below the straight road despite it being slower and
// longer: 2.4 × 0.34 ≈ 0.81 < 1.0.
