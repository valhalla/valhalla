...
//           if
//           (json["routes"][0]["legs"][0]["steps"][steps]["intersections"][intersection].HasMember(
//                   "bearing"))
...
//     // clang-format off
//     for (rapidjson::SizeType step = 0; step <
//     json["routes"][0]["legs"][0]["steps"].GetArray().Size(); ++step) {

//       int intersection_num =
//       json["routes"][0]["legs"][0]["steps"][step]["intersections"].GetArray().Size(); for (int
//       intersection = 0; intersection < intersection_num; ++intersection) {
//         // Validate `out` edge indexes and headings.
//         if
//         (json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection].HasMember("out"))
//         {
//           int out_index =
//           json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection]["out"].GetInt();
//           EXPECT_EQ(out_index, out_indexes[out_cnt++]) << "FAILED at step " << step
//           << ", intersection " << intersection;

//           if
//           (json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection].HasMember("bearings"))
//           {
//             if (!step) {
//               EXPECT_EQ(json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection]["bearings"]
//                         [out_index].GetInt(),0) << "FAILED at step " << step << ", intersection "
//                         << intersection;
//             } else if (step == 1) {
//                 // All bearings have the same angle, 90.
//                 EXPECT_EQ(json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection]["bearings"]
//                 [out_index].GetInt(),90) << "FAILED at step " << step << ", intersection " <<
//                 intersection;
//             } else { // step 3
//               // All bearings have the same angle, 270.
//               EXPECT_EQ(json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection]["bearings"]
//               [out_index].GetInt(), 270) << "FAILED at step " << step << ", intersection " <<
//               intersection;
//             }
//           }
//         }
...
//         // Validate `in` edge indexes and headings.
//         if
//         (json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection].HasMember("in"))
//         {
//           int in_index =
//           json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection]["in"].GetInt();
//           EXPECT_EQ(in_index, in_indexes[in_cnt++]) << "FAILED at step " << step << ", intersection
//           " << intersection;
...
//   "test/data/osrm_serializer_auto_route");
...
//   for (rapidjson::SizeType step = 0; step <
//   json["routes"][0]["legs"][0]["steps"].GetArray().Size();
//        ++step) {
//     int intersection_num =
...
//         int out_index =
//         json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection]["out"].GetInt();
//         EXPECT_EQ(out_index, out_indexes[index]) << "FAILED at step " << step << ", intersection "
//         << intersection;
...
//         json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection]["bearings"]
//                           [out_index].GetInt();
//         EXPECT_EQ(out_heading, out_headings[index++]) << "FAILED at step " << step << ",
//         intersection "
//                                                            << intersection;
//       } else if (step < 4) {
//         ASSERT_TRUE(json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection].HasMember("out"));
...
//         int out_heading =
//         json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection]["bearings"][out_index]
//                                   .GetInt();
...
//         int in_heading =
//         json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection]["bearings"][in_index]
//                                  .GetInt();
...
//         int in_index =
//         json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection]["in"].GetInt();
//         EXPECT_EQ(in_index, in_indexes[index]) << "FAILED at step " << step << ", intersection " <<
//         intersection;
...
//         json["routes"][0]["legs"][0]["steps"][step]["intersections"][intersection]["bearings"][in_index]
//                                  .GetInt();
//         EXPECT_EQ(in_heading, in_headings[index++]) << "FAILED at step " << step << ", intersection
//         " << intersection;
//       }
//     }
//   }
...
//                             {"CD", {{"name", "Course Drive"}, {"highway", "primary"}, {"ref",
//                             "R2"}}},
//                             {"BX", {{"highway", "motorway"}}},
//                             {"CY", {{"highway", "primary"}}},
//                             {"CZ", {{"highway", "primary"}}}};
...
//     const gurka::ways ways =
//         {{"ABCYZDEFG", {{"name", "Grand Rotary"}, {"highway", "primary"}, {"junction",
//         "circular"}}},
