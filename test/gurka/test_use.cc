...
TEST_F(Use, test_entering_rest_area) {
  ...
  gurka::assert::raw::expect_instructions_at_maneuver_index(
      ...
      "Turn left. Then You will arrive at your destination.", "Turn left toward Rest Area.",
...
TEST_F(Use, test_entering_service_area) {
  ...
  gurka::assert::raw::expect_instructions_at_maneuver_index(
      ...
      "Turn left. Then You will arrive at your destination.", "Turn left toward Service Area.",
