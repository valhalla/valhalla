...
protected:
  ...
  static void SetUpTestSuite() {
    ...
    const gurka::ways ways =
        {{"DE", {{"highway", "motorway"}, {"oneway", "yes"}, {"maxspeed", "55"}, {"name", "RT 36"}}},
         {"EF", {{"highway", "motorway"}, {"oneway", "yes"}, {"maxspeed", "55"}, {"name", "RT 36"}}},
         {"FG", {{"highway", "motorway"}, {"oneway", "yes"}, {"maxspeed", "55"}, {"name", "RT 36"}}},
         {"EA",
