  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"name:pronunciation:katakana", "Chaussée de Gand P - Steenweg op Gent P/Gentsesteenweg P"},
        {"name:fr:pronunciation:katakana", "Chaussée de Gand P"},
        {"name:left:pronunciation:katakana", "Chaussée de Gand P - Gentsesteenweg P"},
        {"name:left:nl:pronunciation:katakana", "Gentsesteenweg P"},
        {"name:right:pronunciation:katakana", "Chaussée de Gand P - Steenweg op Gent P"},
        {"name:right:nl:pronunciation:katakana", "Steenweg op Gent P"}}}};
...
TEST(Standalone, Names) {
  ...
  const std::string workdir = "test/data/gurka_phonemes_katakana_w_langs";
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"alt_name:pronunciation:katakana",
         "Chaussée de Gand P - Steenweg op Gent P/Gentsesteenweg P"},
        {"alt_name:fr:pronunciation:katakana", "Chaussée de Gand P"},
        {"alt_name:left:pronunciation:katakana", "Chaussée de Gand P - Gentsesteenweg P"},
        {"alt_name:left:nl:pronunciation:katakana", "Gentsesteenweg P"},
        {"alt_name:right:pronunciation:katakana", "Chaussée de Gand P - Steenweg op Gent P"},
        {"alt_name:right:nl:pronunciation:katakana", "Steenweg op Gent P"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"official_name:pronunciation:katakana",
         "Chaussée de Gand P - Steenweg op Gent P/Gentsesteenweg P"},
        {"official_name:fr:pronunciation:katakana", "Chaussée de Gand P"},
        {"official_name:left:pronunciation:katakana", "Chaussée de Gand P - Gentsesteenweg P"},
        {"official_name:left:nl:pronunciation:katakana", "Gentsesteenweg P"},
        {"official_name:right:pronunciation:katakana", "Chaussée de Gand P - Steenweg op Gent P"},
        {"official_name:right:nl:pronunciation:katakana", "Steenweg op Gent P"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"tunnel:name:pronunciation:katakana",
         "Chaussée de Gand P - Steenweg op Gent P/Gentsesteenweg P"},
        {"tunnel:name:fr:pronunciation:katakana", "Chaussée de Gand P"},
        {"tunnel:name:left:pronunciation:katakana", "Chaussée de Gand P - Gentsesteenweg P"},
        {"tunnel:name:left:nl:pronunciation:katakana", "Gentsesteenweg P"},
        {"tunnel:name:right:pronunciation:katakana", "Chaussée de Gand P - Steenweg op Gent P"},
        {"tunnel:name:right:nl:pronunciation:katakana", "Steenweg op Gent P"}}}};
...
valhalla::gurka::map BuildPBFFB(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk"},
                              ...
                              {"name:pronunciation:katakana", "Gentsesteenweg P;Chaussée de Gand P"},
                              {"name:forward:pronunciation:katakana", "Gentsesteenweg P"},
                              {"name:forward:nl:pronunciation:katakana", "Gentsesteenweg P"},
                              {"name:backward:pronunciation:katakana", "Chaussée de Gand P"},
                              {"name:backward:fr:pronunciation:katakana", "Chaussée de Gand P"}}}};
...
valhalla::gurka::map BuildPBFRefLR(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk"},
                              ...
                              {"ref:pronunciation:katakana", "10 P;11 P"},
                              {"ref:right:pronunciation:katakana", "10 P"},
                              {"ref:right:nl:pronunciation:katakana", "10 P"},
                              {"ref:left:pronunciation:katakana", "11 P"},
                              {"ref:left:fr:pronunciation:katakana", "11 P"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:lang:nl:pronunciation:katakana",
         "destination:lang:nl:pronunciation:katakana"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:street:lang:nl:pronunciation:katakana",
         "destination:lang:nl:pronunciation:katakana"}}}};
...
valhalla::gurka::map BuildPBFDestinationStreetTo(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk"},
                              ...
                              {"destination:street:to:lang:nl:pronunciation:katakana",
                               "destination:lang:nl:pronunciation:katakana"}}}};
      ...
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:forward:pronunciation:katakana",
         "destination:forward:lang:nl:pronunciation:katakana"}, // this is really optional
        {"destination:backward:pronunciation:katakana",
         "destination:backward:lang:fr:pronunciation:katakana"}, // this is really optional
        {"destination:forward:lang:nl:pronunciation:katakana",
         "destination:forward:lang:nl:pronunciation:katakana"},
        {"destination:backward:lang:fr:pronunciation:katakana",
         "destination:backward:lang:fr:pronunciation:katakana"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:lang:nl:pronunciation:katakana", "destination pronunciation in dutch"},
        {"destination:lang:fr:pronunciation:katakana", "destination pronunciation in french"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:ref:lang:nl:pronunciation:katakana",
         "destination:lang:nl:pronunciation:katakana"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:ref:to:lang:nl:pronunciation:katakana",
         "destination:lang:nl:pronunciation:katakana"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk_link"},
        ...
        //{"junction:ref:nl", "junction:ref:lang:nl"}, //not needed as lang is in next tag
        {"junction:ref:nl:pronunciation:katakana", "junction:nl:pronunciation:katakana"}}}};
  ...
  for (const auto& sign : signs) {
    ...
    if (sign_index == 0) {
      ...
      EXPECT_EQ(to_string(
                ...
                "nl");
      EXPECT_EQ(std::get<kLinguisticMapTuplePronunciationIndex>(iter->second),
                "junction:nl:pronunciation:katakana");
      EXPECT_EQ(static_cast<int>(std::get<kLinguisticMapTuplePhoneticAlphabetIndex>(iter->second)),
                static_cast<int>(baldr::PronunciationAlphabet::kKatakana));
    }
    ++sign_index;
...
valhalla::gurka::map BuildPBFNodeRef(const std::string& workdir) {
  ...
  const gurka::nodes nodes = {{"B",
                               {{"ref", "node ref"},
                                ...
                                {"ref:nl:pronunciation:katakana", "ref:nl:pronunciation:katakana"}}}};
  ...
  const gurka::nodes nodes = {
      {"C",
       {{"highway", "traffic_signals"},
        ...
        {"name:ja:pronunciation:katakana", "両国二丁目 pronunciation"},
        {"name:en:pronunciation:katakana", "Ryogoku 2-chome pronunciation"}}}};
...
valhalla::gurka::map BuildPBFNamesCanada(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk"},
                              {"osm_id", "101"},
                              {"name:en:pronunciation:katakana", "dV|fi \"lek *\"rod"},
                              {"name:pronunciation:katakana", "dV|fi \"lek *\"rod"},
                              {"name:en", "Duffy Lake Road"},
                              {"name", "Duffy Lake Road"},
                              {"ref:pronunciation:katakana", "haI|%we \"naIn|ti *\"naIn \"nORt"},
                              {"ref", "HWY-99"}}}};
...
valhalla::gurka::map BuildPBFOldDataDestination(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk"},
                              ...
                              {"destination:pronunciation:katakana", "katakana phoneme"}}}};
...
valhalla::gurka::map BuildPBFJunction(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk_link"},
                              ...
                              {"junction:name:ja:pronunciation:katakana", "ja katakana"},
  ...
  for (const auto& sign : signs) {
    ...
    if (sign_index == 0) {
      ...
      EXPECT_EQ(to_string(
                    static_cast<Language>(std::get<kLinguisticMapTupleLanguageIndex>(iter->second))),
                "ja");
      EXPECT_EQ(std::get<kLinguisticMapTuplePronunciationIndex>(iter->second), "ja katakana");
      EXPECT_EQ(static_cast<int>(std::get<kLinguisticMapTuplePhoneticAlphabetIndex>(iter->second)),
                static_cast<int>(baldr::PronunciationAlphabet::kKatakana));
    } else if (sign_index == 1) {
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "secondary"},
        ...
        {"name:ta", "ரோச்சோர்"},
        {"name:zh", "梧槽"},
        {"name:en:pronunciation:katakana", "English Language pronunciation"},
        {"name:zh:pronunciation:katakana", "Native zh Language pronunciation"},
        // removed for testing dropping of phonems
        // {"name:ms:pronunciation:katakana", "Native ms Language pronunciation"},
        {"name:ta:pronunciation:katakana", "Native ta Language pronunciation"},
        {"name:pronunciation:katakana", "English Language pronunciation"}}}};
...
valhalla::gurka::map BuildPBFMultiPhonemes2(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk"},
                              ...
                              {"destination:lang:en:pronunciation:katakana", "Rochor katakana"},
                              // removed for testing dropping of phonems
                              //{"destination:lang:ms:pronunciation:katakana", "Rochor katakana"},
                              {"destination:lang:ta:pronunciation:katakana", "ரோச்சோர் katakana"},
                              {"destination:lang:zh:pronunciation:katakana", "梧槽 katakana"}}}};
    ...
    for (const auto& sign : signs) {
      ...
      if (sign_index == 0) {
        ...
        EXPECT_EQ(to_string(static_cast<Language>(
                      std::get<kLinguisticMapTupleLanguageIndex>(iter->second))),
                  "en");
        EXPECT_EQ(std::get<kLinguisticMapTuplePronunciationIndex>(iter->second), "Rochor katakana");
        EXPECT_EQ(static_cast<int>(std::get<kLinguisticMapTuplePhoneticAlphabetIndex>(iter->second)),
                  static_cast<int>(baldr::PronunciationAlphabet::kKatakana));
      } else if (sign_index == 1) {
        ...
        EXPECT_EQ(to_string(static_cast<Language>(
                      std::get<kLinguisticMapTupleLanguageIndex>(iter->second))),
                  "zh");
        EXPECT_EQ(std::get<kLinguisticMapTuplePronunciationIndex>(iter->second), "梧槽 katakana");
        EXPECT_EQ(static_cast<int>(std::get<kLinguisticMapTuplePhoneticAlphabetIndex>(iter->second)),
                  static_cast<int>(baldr::PronunciationAlphabet::kKatakana));
        ...
        EXPECT_EQ(to_string(static_cast<Language>(
                      std::get<kLinguisticMapTupleLanguageIndex>(iter->second))),
                  "ta");
        EXPECT_EQ(std::get<kLinguisticMapTuplePronunciationIndex>(iter->second), "ரோச்சோர் katakana");
        EXPECT_EQ(static_cast<int>(std::get<kLinguisticMapTuplePhoneticAlphabetIndex>(iter->second)),
                  static_cast<int>(baldr::PronunciationAlphabet::kKatakana));
      }
      ++sign_index;
