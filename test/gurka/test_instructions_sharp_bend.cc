...
protected:
  ...
  static void SetUpTestSuite() {
    ...
    const gurka::ways ways =
        {{"AB", {{"highway", "primary"}, {"name", "下田石廊松崎線t"}, {"ref", "16"}}},
         {"BC", {{"highway", "primary"}, {"name", "下田石廊松崎線t"}, {"ref", "16"}}},
         {"CD", {{"highway", "primary"}, {"name", "下田石廊松崎線t"}, {"ref", "16"}}},
         {"DE", {{"highway", "primary"}, {"name", "下田石廊松崎線t"}, {"ref", "16"}}},
