  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"name:pronunciation", "Chaussée de Gand P - Steenweg op Gent P/Gentsesteenweg P"},
        {"name:fr:pronunciation", "Chaussée de Gand P"},
        {"name:left:pronunciation", "Chaussée de Gand P - Gentsesteenweg P"},
        {"name:left:nl:pronunciation", "Gentsesteenweg P"},
        {"name:right:pronunciation", "Chaussée de Gand P - Steenweg op Gent P"},
        {"name:right:nl:pronunciation", "Steenweg op Gent P"}}}};
...
TEST(Standalone, Names) {
  ...
  const std::string workdir = "test/data/gurka_phonemes_ipa_w_langs";
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"alt_name:pronunciation", "Chaussée de Gand P - Steenweg op Gent P/Gentsesteenweg P"},
        {"alt_name:fr:pronunciation", "Chaussée de Gand P"},
        {"alt_name:left:pronunciation", "Chaussée de Gand P - Gentsesteenweg P"},
        {"alt_name:left:nl:pronunciation", "Gentsesteenweg P"},
        {"alt_name:right:pronunciation", "Chaussée de Gand P - Steenweg op Gent P"},
        {"alt_name:right:nl:pronunciation", "Steenweg op Gent P"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"official_name:pronunciation", "Chaussée de Gand P - Steenweg op Gent P/Gentsesteenweg P"},
        {"official_name:fr:pronunciation", "Chaussée de Gand P"},
        {"official_name:left:pronunciation", "Chaussée de Gand P - Gentsesteenweg P"},
        {"official_name:left:nl:pronunciation", "Gentsesteenweg P"},
        {"official_name:right:pronunciation", "Chaussée de Gand P - Steenweg op Gent P"},
        {"official_name:right:nl:pronunciation", "Steenweg op Gent P"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"tunnel:name:pronunciation", "Chaussée de Gand P - Steenweg op Gent P/Gentsesteenweg P"},
        {"tunnel:name:fr:pronunciation", "Chaussée de Gand P"},
        {"tunnel:name:left:pronunciation", "Chaussée de Gand P - Gentsesteenweg P"},
        {"tunnel:name:left:nl:pronunciation", "Gentsesteenweg P"},
        {"tunnel:name:right:pronunciation", "Chaussée de Gand P - Steenweg op Gent P"},
        {"tunnel:name:right:nl:pronunciation", "Steenweg op Gent P"}}}};
...
valhalla::gurka::map BuildPBFFB(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk"},
                              ...
                              {"name:pronunciation", "Gentsesteenweg P;Chaussée de Gand P"},
                              {"name:forward:pronunciation", "Gentsesteenweg P"},
                              {"name:forward:nl:pronunciation", "Gentsesteenweg P"},
                              {"name:backward:pronunciation", "Chaussée de Gand P"},
                              {"name:backward:fr:pronunciation", "Chaussée de Gand P"}}}};
...
valhalla::gurka::map BuildPBFRefLR(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk"},
                              ...
                              {"ref:pronunciation", "10 P;11 P"},
                              {"ref:right:pronunciation", "10 P"},
                              {"ref:right:nl:pronunciation", "10 P"},
                              {"ref:left:pronunciation", "11 P"},
                              {"ref:left:fr:pronunciation", "11 P"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:lang:nl:pronunciation", "destination:lang:nl:pronunciation"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:street:lang:nl:pronunciation", "destination:lang:nl:pronunciation"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:street:to:lang:nl:pronunciation", "destination:lang:nl:pronunciation"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:forward:pronunciation",
         "destination:forward:lang:nl:pronunciation"}, // this is really optional
        {"destination:backward:pronunciation",
         "destination:backward:lang:fr:pronunciation"}, // this is really optional
        {"destination:forward:lang:nl:pronunciation", "destination:forward:lang:nl:pronunciation"},
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:lang:nl:pronunciation", "destination pronunciation in dutch"},
        {"destination:lang:fr:pronunciation", "destination pronunciation in french"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:ref:lang:nl:pronunciation", "destination:lang:nl:pronunciation"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk"},
        ...
        {"destination:ref:to:lang:nl:pronunciation", "destination:lang:nl:pronunciation"}}}};
  ...
  const gurka::ways ways = {
      {"BC",
       {{"highway", "trunk_link"},
        ...
        {"junction:ref:nl:pronunciation", "junction:nl:pronunciation"}}}};
...
valhalla::gurka::map BuildPBFNodeRef(const std::string& workdir) {
  ...
  const gurka::nodes nodes = {{"B",
                               {{"ref", "node ref"},
                                ...
                                {"ref:nl:pronunciation", "ref:nl:pronunciation"}}}};
...
valhalla::gurka::map BuildPBFNodeName(const std::string& workdir) {
  ...
  const gurka::nodes nodes = {{"C",
                               {{"highway", "traffic_signals"},
                                ...
                                {"name:ja:pronunciation", "両国二丁目 pronunciation"},
                                {"name:en:pronunciation", "Ryogoku 2-chome pronunciation"}}}};
...
valhalla::gurka::map BuildPBFNamesCanada(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk"},
                              {"osm_id", "101"},
                              {"name:en:pronunciation", "dV|fi \"lek *\"rod"},
                              {"name:pronunciation", "dV|fi \"lek *\"rod"},
                              {"name:en", "Duffy Lake Road"},
                              {"name", "Duffy Lake Road"},
                              {"ref:pronunciation", "haI|%we \"naIn|ti *\"naIn \"nORt"},
                              {"ref", "HWY-99"}}}};
...
valhalla::gurka::map BuildPBFOldDataDestination(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk"},
                              ...
                              {"destination:pronunciation", "ipa phoneme"}}}};
...
valhalla::gurka::map BuildPBFJunction(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk_link"},
                              ...
                              {"junction:name:ja:pronunciation", "ja ipa"},
...
valhalla::gurka::map BuildPBFMultiPhonemes(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "secondary"},
                              ...
                              {"name:ta", "ரோச்சோர்"},
                              {"name:zh", "梧槽"},
                              {"name:en:pronunciation", "English Language pronunciation"},
                              {"name:zh:pronunciation", "Native zh Language pronunciation"},
                              // removed for testing dropping of phonemes
                              // {"name:ms:pronunciation", "Native ms Language pronunciation"},
                              {"name:ta:pronunciation", "Native ta Language pronunciation"},
                              {"name:pronunciation", "English Language pronunciation"}}}};
...
valhalla::gurka::map BuildPBFMultiPhonemes2(const std::string& workdir) {
  ...
  const gurka::ways ways = {{"BC",
                             {{"highway", "trunk"},
                              ...
                              {"destination:lang:en:pronunciation", "Rochor ipa"},
                              // removed for testing dropping of phonems
                              //{"destination:lang:ms:pronunciation", "Rochor ipa"},
                              {"destination:lang:ta:pronunciation", "ரோச்சோர் ipa"},
                              {"destination:lang:zh:pronunciation", "梧槽 ipa"}}}};
