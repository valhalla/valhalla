...
TEST(Signinfo, ExitToTest) {
  ...
  signs.clear();
  has_guide = GraphBuilder::CreateSignInfoList(node, way, pronunciation, osmdata, default_languages,
                                               signs, linguistics, fork, forward, true, false);
  ...
  way.set_destination_ref_index(index);
  has_guide = GraphBuilder::CreateSignInfoList(node, way, pronunciation, osmdata, default_languages,
                                               signs, linguistics, fork, forward, false, true);
  ...
  has_guide = GraphBuilder::CreateSignInfoList(node, way2, pronunciation, osmdata, default_languages,
                                               signs, linguistics, fork, forward, true, false);
