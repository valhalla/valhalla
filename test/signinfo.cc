...
void ExitToTest() {
  ...
  bool has_guide = GraphBuilder::CreateExitSignInfoList(node, way, osmdata, exitsigns, fork, forward, true);
  ...
  has_guide = GraphBuilder::CreateExitSignInfoList(node, way, osmdata, exitsigns, fork, forward, true);
  ...
  has_guide = GraphBuilder::CreateExitSignInfoList(node, way2, osmdata, exitsigns, fork, forward, true);
