...
void do_varint_pair(const container_t& points) {
  ...
  if(!appx_equal(dec_answer, points))
    throw std::runtime_error("Simple varint encode decode loop failed. Expected: " + to_string(points) + " Got: " + to_string(dec_answer));
}
