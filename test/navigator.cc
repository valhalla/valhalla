...
//  TryCtor("{\"trip\":{\"language\":\"en-US\",
//  \"summary\":{\"max_lon\":-76.276863,\"max_lat\":40.063713,\"time\":287,\"length\":2.168,\"min_lat\":40.042500,\"min_lon\":-76.299324},
//  \"locations\":[{\"street\":\"East Fulton Street\",\"lon\":-76.299332,\"lat\":40.042538,\"type\":\"break\"},{\"type\":\"break\",\"side_of_street\":\"right\",\"lat\":40.063747,\"lon\":-76.282028,\"street\":\"US 30 West\"}],
//  \"units\":\"miles\",
//  \"legs\":[{\"shape\":\"e__kkAxb}opCcBq\\sFk`Aqp@`HqRxBexAfNwHk@y`AgwA{KePed@qp@iCwDwM_S{z@snAemA}gByoAekBqGoJgJwMiGmJiv@}hAil@q{@eU_]s_@{j@gYwc@mi@}}@qMiW{F}JcPwX}Ymi@}Zmi@yoAqxBiHwNqk@gbA_Xqf@aDkKyVee@}OiWqBwCwI{Ks[a\\iByB}D`HkGjKoHfNmEnIuE|IsGfOkUhl@{KvWeK~SaBvDaNhVwRp]c[li@eUrd@sL`S\",
//  \"summary\":{\"max_lon\":-76.276863,\"max_lat\":40.063713,\"time\":287,\"length\":2.168,\"min_lat\":40.042500,\"min_lon\":-76.299324},
