...
namespace {
  ...
  std::list<std::pair<std::string, std::string>> failure_request_responses {
   ...
   // {"{\"locations\":[{\"lat\":0,\"lon\":90}],\"costing\":\"auto\",\"correlated_0\":{\"edges\":[{\"id\":\"1343687978654\",\"dist\":\"0.7936895\",\"sos\":\"2\"},{\"id\":\"3091605450398\",\"dist\":\"0.2063105\",\"sos\":\"1\"}        ],\"is_node\":\"false\",\"vertex\":{\"lon\":\"-76.29807\",\"lat\":\"40.04407\"},\"location_index\":\"0\"}}","Failed to parse intermediate request format"},
