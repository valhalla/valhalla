...
| `private_access_penalty` | A penalty applied when a [gate](https://wiki.openstreetmap.org/wiki/Tag:barrier%3Dgate) with `access=private` is encountered. The default private access penalty is 450 seconds. |
