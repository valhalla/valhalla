...
| `exclude_unpaved` | This value indicates the willingness to take unpaved roads. If `exclude_unpaved` is set to 1, unpaved roads are excluded from the process of generating the route path, otherwise included. |
