...
## Configuring
A sample configuration file (`maproulette.json`) must be configured before this tool will work properly. Additionally, you will have to do some setup on the [maproulette website](https://maproulette.org).
...
If you have gotten here and don't know what geojson you should have, [click here](geojson.md) to learn more.
