...
You can also set `directions_options` to specify output units, language, and whether or not to return directions in a narrative form. Refer to the [route options](route/api-reference.md#directions-options) documentation for examples.
...
The outputs of the `trace_route` action are the same as the [outputs of a route](route/api-reference.md#outputs-of-a-route) action.
