...
| `minimum_inbound_reachability` | Minimum number of nodes (intersections) reachable for a given edge from the inbound direction. See `minimum_reachability`. |
| `minimum_outbound_reachability` | Minimum number of nodes (intersections) reachable for a given edge from the outbound direction. See `minimum_reachability`. |
