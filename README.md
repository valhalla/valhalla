...
2. PR description (re-)written by a human is non-negotiable; an agent may translate human-written text into idiomatic English as commonly written on GitHub without adding, removing, or reorganizing content
