...
struct build_stats {
  ...
  static constexpr meta_entry meta[] = {
      ...
      {"lane_connectivity_failed", "lane connectivity import failures", BuildStage::kBuild, true},
      ...
      {"access_tags_not_found", "edges with access tags not found", BuildStage::kEnhance, true},
      {"unrecognized_hov_type", "ways with unrecognized HOV type", BuildStage::kParseWays, true},
      {"tag_parse_error", "tag parse errors", BuildStage::kParseWays, true},
