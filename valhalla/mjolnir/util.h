...
struct build_stats {
  ...
  static constexpr meta_entry meta[] = {
      ...
      {"count_pedestrian_areas", "pedestrian areas materialized", BuildStage::kBuildAreas, false},
      {"count_pedestrian_area_edges", "traversal edges generated for pedestrian areas",
