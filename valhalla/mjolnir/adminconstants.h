...
const std::unordered_map<std::string, std::vector<int>> kCountryAccess {
    ...
    {"Austria",                   {(kAutoAccess | kTruckAccess | kBusAccess),
                                   (kAutoAccess | kTruckAccess | kBusAccess),
                                   -1, -1, -1, -1, -1,  (kPedestrianAccess | kWheelchairAccess)}},
    {"Belarus",                   {-1, -1, -1, (kPedestrianAccess | kWheelchairAccess | kBicycleAccess),
                                   (kPedestrianAccess | kWheelchairAccess | kBicycleAccess), -1,
                                   (kPedestrianAccess | kWheelchairAccess | kBicycleAccess), -1}},
    {"Belgium",                   {(kAutoAccess | kTruckAccess | kBusAccess),
                                   (kAutoAccess | kTruckAccess | kBusAccess),
    ...
    {"Brazil",                    {-1, -1, -1, (kPedestrianAccess | kWheelchairAccess | kBicycleAccess),
                                    ...
                                    (kPedestrianAccess | kWheelchairAccess | kBicycleAccess), -1}},
    {"Denmark",                   {(kAutoAccess | kTruckAccess | kBusAccess),
                                   (kAutoAccess | kTruckAccess | kBusAccess),
                                   -1, -1, -1, -1, (kPedestrianAccess | kWheelchairAccess | kBicycleAccess), -1}},
    {"France",                    {(kAutoAccess | kTruckAccess | kBusAccess),
                                   (kAutoAccess | kTruckAccess | kBusAccess), -1, -1,
    ...
    {"Hungary",                   {(kAutoAccess | kTruckAccess | kBusAccess),
                                   (kAutoAccess | kTruckAccess | kBusAccess),
                                   -1, -1, -1, -1, -1, -1}},
    {"The Netherlands",           {(kAutoAccess | kTruckAccess | kBusAccess),
                                   (kAutoAccess | kTruckAccess | kBusAccess),
                                   -1, -1, -1, -1, (kPedestrianAccess | kWheelchairAccess | kBicycleAccess), -1}},
    {"Norway",                    {-1,-1, -1,
                                   (kPedestrianAccess | kWheelchairAccess | kBicycleAccess), (kPedestrianAccess | kWheelchairAccess | kBicycleAccess),
                                   -1, (kPedestrianAccess | kWheelchairAccess | kBicycleAccess), -1}},
    {"Poland",                    {(kAutoAccess | kTruckAccess | kBusAccess),
                                   (kAutoAccess | kTruckAccess | kBusAccess),
                                   -1, -1, -1, -1, -1, -1}},
    {"Romania",                   {(kAutoAccess | kTruckAccess | kBusAccess),
                                   (kAutoAccess | kTruckAccess | kBusAccess),
                                   -1, -1, -1, -1, -1, -1}},
    {"Slovakia",                  {(kAutoAccess | kTruckAccess | kBusAccess),
                                   (kAutoAccess | kTruckAccess | kBusAccess),
                                   -1, -1, -1, -1, -1, -1}},
    {"Switzerland",               {(kAutoAccess | kTruckAccess | kBusAccess),
                                   (kAutoAccess | kTruckAccess | kBusAccess),
                                   -1, -1, -1, -1, -1, -1}},
