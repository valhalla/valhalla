...
const std::unordered_map<std::string, std::vector<int>>
    kCountryAccess{{"Australia",
                   ...
                   {"Austria",
                    {(kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess | kTaxiAccess | kMotorcycleAccess),
                     (kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess | kTaxiAccess | kMotorcycleAccess), -1,
