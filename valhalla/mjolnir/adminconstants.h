...
const std::unordered_map<std::string, std::vector<int>> kCountryAccess{
    ...
    {"Austria",
     {(kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess | kMotorcycleAccess),
      (kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess | kMotorcycleAccess), -1, -1, -1, -1,
      -1, (kPedestrianAccess | kWheelchairAccess), -1}},
    {"Belarus",
     {-1, -1, -1, (kPedestrianAccess | kWheelchairAccess | kBicycleAccess),
    ...
    {"Brazil",
     {-1, -1, -1, (kPedestrianAccess | kWheelchairAccess | kBicycleAccess | kMopedAccess), -1,
      (kPedestrianAccess | kWheelchairAccess | kBicycleAccess | kMopedAccess),
      (kPedestrianAccess | kWheelchairAccess | kBicycleAccess | kMopedAccess),
      (kPedestrianAccess | kWheelchairAccess | kBicycleAccess | kMopedAccess), -1}},
    {"Denmark",
    ...
    {"Romania",
     {(kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess | kMotorcycleAccess),
      (kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess | kMotorcycleAccess), -1, -1, -1, -1,
      -1, (kPedestrianAccess | kWheelchairAccess | kBicycleAccess | kMopedAccess), -1}},
