...
const std::unordered_map<std::string, std::vector<int>> kCountryAccess{
    ...
    {"Austria",
     {(kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess),
      (kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess), -1, -1, -1, -1, -1,
      (kPedestrianAccess | kWheelchairAccess), -1}},
    {"Belarus",
     {-1, -1, -1, (kPedestrianAccess | kWheelchairAccess | kBicycleAccess),
    ...
    {"Hungary",
     {(kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess),
      (kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess), -1, -1, -1, -1, -1, -1, -1}},
    {"The Netherlands",
     {(kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess),
      (kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess), -1, -1, -1, -1,
      (kPedestrianAccess | kWheelchairAccess | kBicycleAccess),
      (kPedestrianAccess | kWheelchairAccess | kBicycleAccess | kMopedAccess), -1}},
    {"Norway",
     {-1, -1, -1, (kPedestrianAccess | kWheelchairAccess | kBicycleAccess),
    ...
    {"Spain",
     {-1, -1, -1, -1, -1, -1, -1,
      (kPedestrianAccess | kWheelchairAccess | kBicycleAccess | kMopedAccess),
      (kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess | kBicycleAccess)}},
    {"Switzerland",
     {(kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess),
      (kAutoAccess | kTruckAccess | kBusAccess | kHOVAccess), -1, -1, -1, -1,
