...
const re::regex kUsNumberSplitRegex("(\\D*)(\\d+)(st|nd|rd|th)?(\\D*)", re::regex_constants::icase);

const re::regex kInterstateRegex("(\\bI)([ -])(H)?(\\d{1,3})", re::regex_constants::icase);
const std::string kInterstateOutPattern = "Interstate $3$4";

const re::regex kUsHighwayRegex("(\\bUS)([ -])(Highway )?(\\d{1,3})", re::regex_constants::icase);
...
const std::array<std::pair<re::regex, std::string>, 7> kCountyRoutes = {
    {{re::regex("(\\bCR)(\\d{1,4})([[:alpha:]]{1,2})?\\b", re::regex_constants::icase),
      "County Route $2$3"},
     {re::regex("(\\bCR)([ -])([[:alpha:]]{1,2})?(\\d{1,4})([[:alpha:]]{1,2})?\\b",
                re::regex_constants::icase),
      "County Route $3$4$5"},
     {re::regex("(\\bCR)([ -])([[:alpha:]]{1,2})\\b", re::regex_constants::icase),
      "County Route $3"},
     {re::regex("(\\bC R)(\\d{1,4})([[:alpha:]]{1,2})?\\b", re::regex_constants::icase),
      "County Route $2$3"},
     {re::regex("(\\bC R)([ -])([[:alpha:]]{1,2})?(\\d{1,4})([[:alpha:]]{1,2})?\\b",
                re::regex_constants::icase),
      "County Route $3$4$5"},
     {re::regex("(\\bC R)([ -])([[:alpha:]]{1,2})\\b", re::regex_constants::icase),
      "County Route $3"},
     {re::regex("(\\bCO)([ -])?(\\d{1,4})([[:alpha:]]{1,2})?\\b", re::regex_constants::icase),
      "County Road $3$4"}}};
