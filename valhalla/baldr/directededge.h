...
public:
  ...
  /**
   * Get the truck speed type (see graphconstants.h)
   ...
   * @param  speed_type  Speed type.
   */
  void set_truck_speed_type(const SpeedType speed_type);
...
protected:
  ...
  uint64_t truck_speed_type_ : 1; // Truck speed type (see speed type)
  uint64_t spare4_ : 2;
