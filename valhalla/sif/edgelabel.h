...
public:
  ...
  EdgeLabel()
      : predecessor_(baldr::kInvalidLabel), path_distance_(0), restrictions_(0),
        ...
        on_complex_rest_(0), closure_pruning_(0), path_id_(0), restriction_idx_(0), 
        internal_turn_(0), unpaved_(0), has_measured_speed_(0), hgv_access_(0), 
        bridge_(0), tunnel_(0), destonly_access_restr_mask_(0), cost_(0, 0), sortcost_(0) {
