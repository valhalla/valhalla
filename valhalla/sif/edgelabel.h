...
public:
  ...
  EdgeLabel()
      : predecessor_(baldr::kInvalidLabel), path_distance_(0), restrictions_(0),
        ...
        destonly_access_restr_mask_(0), spare(0), cost_(0, 0), sortcost_(0) {
  ...
  EdgeLabel(const uint32_t predecessor,
      ...
      : predecessor_(predecessor), path_distance_(path_distance), restrictions_(edge->restrictions()),
        ...
        tunnel_(edge->tunnel()), destonly_access_restr_mask_(destonly_access_restr_mask), spare(0),
...
public:
  // Default constructor
  BDEdgeLabel() : opp_edgeid_(0), not_thru_pruning_(0), distance_(0.0f) {
  }
