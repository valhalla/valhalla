...
namespace valhalla {
  namespace thor {
    ...
    class thor_worker_t {
     public:
      enum MATRIX_TYPE { ONE_TO_MANY, MANY_TO_ONE, MANY_TO_MANY, SOURCES_TO_TARGETS, OPTIMIZED_ROUTE};
     ...
     protected:
      ...
      prime_server::worker_t::result_t optimized_path(const std::vector<baldr::PathLocation>& correlated_s, const std::vector<baldr::PathLocation>& correlated_t, const std::string &costing, const std::string &request_str, const bool header_dnt);
