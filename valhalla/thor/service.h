  ...
  namespace thor {
    ...
    class thor_worker_t {
     ...
     protected:
      ...
      prime_server::worker_t::result_t path_arrive_by(std::vector<baldr::PathLocation>& correlated, const std::string &costing, const std::string &request_str, prime_server::worker_t::result_t result);
      prime_server::worker_t::result_t path_depart_from(std::vector<baldr::PathLocation>& correlated, const std::string &costing, const boost::optional<int> &date_time_type, const std::string &request_str, prime_server::worker_t::result_t result);
