  ...
  namespace thor {
    ...
    class thor_worker_t {
     ...
     protected:
      ...
      prime_server::worker_t::result_t trip_path(const std::string &costing, const std::string &request_str, const boost::optional<int> &date_time_type, prime_server::http_request_t::info_t& request_info);
      ...
      prime_server::worker_t::result_t optimized_path(const std::vector<baldr::PathLocation>& correlated, const std::string &costing, const std::string &request_str, prime_server::http_request_t::info_t& request_info);
