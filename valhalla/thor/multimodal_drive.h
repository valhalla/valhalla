 ...
 *
 */
class MultimodalDrive : public PathAlgorithm {
public:
  /**
   * Constructor.
   * @param config A config object of key, value pairs
   */
  explicit MultimodalDrive(const boost::property_tree::ptree& config = {});

  /**
   * Destructor
   */
  virtual ~MultimodalDrive();
...
protected:
  ...
  AStarHeuristic drive_astarheuristic_;

  // Current costing mode
  sif::cost_ptr_t pedestrian_costing_;
  sif::cost_ptr_t drive_costing_;
