...
namespace valhalla {
  namespace loki {
    ...
    class loki_worker_t {
     public:
      enum ACTION_TYPE {ROUTE, VIAROUTE, LOCATE, ONE_TO_MANY, MANY_TO_ONE, MANY_TO_MANY, OPTIMIZED_ORDER};
      ...
      prime_server::worker_t::result_t optimized(boost::property_tree::ptree& request, prime_server::http_request_t::info_t& request_info);
      void cleanup();
     protected:
