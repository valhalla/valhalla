...
* **Bug Fix**
   ...
   * FIXED: inifinte loop or other random corruption in isochrones when retrieving partial shape of an edge [#4547](https://github.com/valhalla/valhalla/pull/4547)
* **Enhancement**
