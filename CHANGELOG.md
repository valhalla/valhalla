...
* **Enhancement**
   ...
   * CHANGED: Migrated from pybind11 to nanobind to release `abi3` wheels (Python version agnostic), also changes minimum version to 3.12 [#5628](https://github.com/valhalla/valhalla/pull/5628)
