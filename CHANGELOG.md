...
* **Enhancement**
   ...
   * ADDED: `disable_hierarchy_pruning` costing option to find the true shortest route for motor-based costings [#4000](https://github.com/valhalla/valhalla/pull/4000)
