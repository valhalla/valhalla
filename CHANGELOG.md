...
* **Enhancement**
   * ADDED: `apply_destination_only_penalty_to_trails` parameter to bicycle and pedestrian costing options [#5643](https://github.com/valhalla/valhalla/issues/5643)
