...
* **Enhancement**
   ...
   * CHANGED: Limit shortcuts to its maximum length (room for improvement: create multiple shortcuts that add up to the total length. Currently, shortcut terminates when maxLength is reached and does not continue) [#3597] (https://github.com/valhalla/valhalla/pull/3597)
