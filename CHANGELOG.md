...
* **Bug Fix**
   *FIXED: incorrect inbound heading calculation in meili get_inbound_edgelabel_heading which previously returned the opposing edge heading instead of the actual travel direction.[#5957]
