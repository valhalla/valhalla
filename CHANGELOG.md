...
* **Bug Fix**
   * FIXED: Typos in the documentation related to building Windows from source [#5294](https://github.com/valhalla/valhalla/pull/5294)
...
* **Enhancement**
   * UPDATED: Build command to use `nmake` on Windows instead of `make`. [#5294](https://github.com/valhalla/valhalla/pull/5294)
