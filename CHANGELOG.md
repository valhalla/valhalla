...
* **Enhancement**
   * ADDED: `zh-CN`, `zh-TW`, `th-TH`, `id-ID` and `ta-IN` narrative locales [#6326](https://github.com/valhalla/valhalla/pull/6326)
   * CHANGED: translated every remaining phrase in ar-SA, de-DE, es-ES, fr-FR, hi-IN, it-IT, ja-JP, ko-KR, nl-NL, pl-PL, pt-BR, pt-PT, sv-SE, tr-TR and vi-VN [#6326](https://github.com/valhalla/valhalla/pull/6326)
