...
10. Before creating or updating the PR, run `CLAUDE.md`'s contributor-agent gate against the full branch diff. Perform the review in the current agent; extra local review tools may supplement the gate. Resolve every finding and commit the fixes first.
