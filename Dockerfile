...
RUN cmake .. -DCMAKE_BUILD_TYPE=Release -DCMAKE_C_COMPILER=gcc -DENABLE_SINGLE_FILES_WERROR=Off -DENABLE_THREAD_SAFE_TILE_REF_COUNT=On -DVALHALLA_VERSION_MODIFIER=${VERSION_MODIFIER}
