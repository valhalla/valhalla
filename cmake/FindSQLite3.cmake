...
if( Sqlite_USE_STATIC_LIBS )
  set( _sqlite_ORIG_CMAKE_FIND_LIBRARY_SUFFIXES ${CMAKE_FIND_LIBRARY_SUFFIXES})
  if(WIN32)
...
if( Sqlite_USE_STATIC_LIBS )
  set(CMAKE_FIND_LIBRARY_SUFFIXES ${_sqlite_ORIG_CMAKE_FIND_LIBRARY_SUFFIXES})
endif()
