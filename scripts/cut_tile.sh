...
#start out with the bathymetry as only a fillter where gmted and srtm have no data (ie -32768)
gdalwarp -multi -wo NUM_THREADS=ALL_CPUS --config GDAL_CACHEMAX 1024 -wm 1024 -r lanczos gebco/gebco.vrt gmted/gmted.vrt srtm/srtm.vrt -te $1 $2 $3 $4 $flat_bathy
...
gdalwarp -multi -wo NUM_THREADS=ALL_CPUS --config GDAL_CACHEMAX 1024 -wm 1024 -r lanczos -srcnodata 0 -dstnodata -32768 gebco/gebco.vrt $flat_bathy -te $1 $2 $3 $4 $1.$2.tif
