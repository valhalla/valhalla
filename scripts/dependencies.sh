...
sudo apt-get install -y autoconf automake libtool make cmake gcc-4.9 g++-4.9 libboost1.54-all-dev lcov protobuf-compiler libprotobuf-dev libcurl4-openssl-dev
